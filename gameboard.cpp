...
void Gameboard::update_gui(QPushButton* c, int pos)
{
    ...
    GameData::instance().is_over = (GameData::instance().win_result.first || GameData::instance().is_tie);

    qDebug() << GameData::instance().win_result.first << GameData::instance().win_result.second << GameData::instance().is_tie
