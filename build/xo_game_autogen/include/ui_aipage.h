...
public:
    ...
    void setupUi(QMainWindow *Aipage)
    {
        if (Aipage->objectName().isEmpty())
            Aipage->setObjectName(QString::fromUtf8("Aipage"));
...
""));
        ...
        start_game_ai->setObjectName(QString::fromUtf8("start_game_ai"));
...
""));
        ...
        turn_box_ai->setObjectName(QString::fromUtf8("turn_box_ai"));
...
""));
        ...
        label_ai->setObjectName(QString::fromUtf8("label_ai"));
...
""));
        ...
        back_tomain_ai->setObjectName(QString::fromUtf8("back_tomain_ai"));
...
""));
        ...
        level_ai->setObjectName(QString::fromUtf8("level_ai"));
...
""));
    ...
    {
        Aipage->setWindowTitle(QApplication::translate("Aipage", "MainWindow", nullptr));
        groupBox_p->setTitle(QString());
        start_game_ai->setText(QApplication::translate("Aipage", "Start Game", nullptr));
        turn_box_ai->setCurrentText(QString());
        label_ai->setText(QApplication::translate("Aipage", "Ai Difficulty \360\237\244\226 and Starting Turn", nullptr));
        back_tomain_ai->setText(QApplication::translate("Aipage", "Back to Main", nullptr));
