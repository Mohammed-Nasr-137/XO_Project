...
public:
    ...
    void setupUi(QMainWindow *Turnpage)
    {
        if (Turnpage->objectName().isEmpty())
            Turnpage->setObjectName(QString::fromUtf8("Turnpage"));
...
""));
        ...
        back_tomain_p->setObjectName(QString::fromUtf8("back_tomain_p"));
...
""));
        ...
        turn_box->setObjectName(QString::fromUtf8("turn_box"));
...
""));
        ...
        groupBox_p_2->setObjectName(QString::fromUtf8("groupBox_p_2"));
...
""));
    ...
    {
        Turnpage->setWindowTitle(QApplication::translate("Turnpage", "MainWindow", nullptr));
        groupBox_p->setTitle(QString());
        start_game->setText(QApplication::translate("Turnpage", "Start Game", nullptr));
        back_tomain_p->setText(QApplication::translate("Turnpage", "Back to Main", nullptr));
        turn_label->setText(QApplication::translate("Turnpage", "Player 1 Turn", nullptr));
